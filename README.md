...
🚀 Proyectos Actuales
Ecommerce Brasil: Pipeline de procesamiento enfocado en análisis de ventas y logística, optimizando grandes volúmenes de datos transaccionales.

Databricks Crypto Pipeline: ETL de punta a punta para el seguimiento de criptoactivos, utilizando lógica de capas (Bronze/Silver/Gold) y Spark SQL.
...
Cada carpeta contiene los Notebooks y archivos .sql organizados por etapa del pipeline. Los recursos están listos para ser importados y ejecutados en un entorno de Databricks.
